  ...
  <el-container class="panel-container">
    ...
    <el-aside width="220px" class="sidebar">
      <el-menu
        ...
        router
      >
        <el-menu-item index="/shop-manage/home">
        ...
        <el-sub-menu index="product">
          ...
          <el-menu-item index="/shop-manage/product/info">商品信息</el-menu-item>
        </el-sub-menu>
        <el-sub-menu index="order">
          ...
          <el-menu-item index="/shop-manage/order/list">商品订单</el-menu-item>
        </el-sub-menu>
      </el-menu>
    </el-aside>
...
import { shopInfoService } from '@/api/shop'
...
// 从 Pinia 中衍生出“实时”的店铺名和头像
const shopName = computed(() => userInfoStore.info.shopName || '店铺名称')
const avatarUrl = computed(() => userInfoStore.info.userPic || '')

const loadShopInfo = async () => {
  try {
    const res = await shopInfoService()
...
.footer-text {
  text-align: center;
  color: #878c8d;
  font-size: 13px; /* 从 12px 调整为 13px，提升可读性 */
  line-height: 1.6;
  padding-bottom: 10px;
}
